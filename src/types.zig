...
fn bindSlice(oid: i32, value: anytype, buf: *buffer.Buffer, format_pos: usize) !void {
    ...
    if (comptime isStringArray(T)) {
        switch (oid) {
            Types.TimestampArray.oid.decimal, Types.NumericArray.oid.decimal => return Encode.writeTextEncodedEscapedArray(value, buf, format_pos),
            Types.TimestampTzArray.oid.decimal, Types.CidrArray.oid.decimal, Types.CidrArray.inet_oid.decimal => return Encode.writeTextEncodedRawArray(value, buf, format_pos),
